...
Also read [Portfolio experience guidance](docs/portfolio-experience-guidance.md) for reference-led creative direction, narrative hierarchy, direct evidence discovery, motion specifications, and separate owner aesthetic review. The [Marketplace direction proposal](docs/design/marketplace-experience-direction/README.md) is a permitted subject of review, not an approved reference or authorization to implement a selected direction.
