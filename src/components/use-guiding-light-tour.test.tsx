...
import { GUIDING_LIGHT_HOLD_MS, useGuidingLightTour } from "@/components/use-guiding-light-tour";
...
describe("Guiding Light tour playback", () => {
  it("selects Learn initially and waits for the narrative to enter view before progressing every 2.8 seconds", () => {
    render(<TourHarness />);
    expect(GUIDING_LIGHT_HOLD_MS).toBe(2800);
    expectTour("Learn", "ready");
    advance(10000);
    expectTour("Learn", "ready");
  ...
  it("waits for motion preference resolution and never automatically starts with reduced motion", () => {
